...
RUN apt-get update -qq && apt-get install -y build-essential libvips gnupg2 curl git libjemalloc2 libclang-dev postgresql-client libpq-dev libyaml-dev default-mysql-client default-libmysqlclient-dev pkg-config
